...
Use `scripts/ns_debug.sh` (written by xfangfang) to pull crash logs off the switch and find exactly where it died:

```console
❯ ./scripts/ns_debug.sh ftp://192.168.20.2:5000 build/akira.elf
